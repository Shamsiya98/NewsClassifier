...
# Read the dataset
bbc_text = pd.read_csv(r"C:\Users\HP\Desktop\duk\NLP\bbc-text.txt")
...
st.header('News Headlines Classifier Demo')
input_text = st.text_area("Please enter the news headlines", value="")
if st.button("Submit"):
    ...
    st.write(f"Predicted news category: {result}")